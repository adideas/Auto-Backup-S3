...
public class IndexedFolderLogger {
    ...
    public static void info(String msg) {
        getInstance().append(Logger.getLine(Column.HOSTNAME.FILES, Column.LEVEL.INFO, msg));
    }
    ...
    public static void error(String msg) {
        getInstance().append(Logger.getLine(Column.HOSTNAME.FILES, Column.LEVEL.ERROR, msg));
    }
}
